...
//					System.out.println("array["+i+"].loc="+pq.getLoc(i));
//					System.out.println("array["+i+"].value="+pq.peek(i));
//					System.out.println("this is child");
//					System.out.println("array["+2*i+1+"].loc="+pq.getLoc(2*i+1));
//					System.out.println("array["+2*i+1+"].value="+pq.peek(2*i+1));
...
//				System.out.println("array["+i+"].value="+pq.peek(i));
//				System.out.println("this is child");
//				System.out.println("array["+2*i+"].loc="+pq.getLoc(2*i));
//				System.out.println("array["+2*i+"].value="+pq.peek(2*i));
